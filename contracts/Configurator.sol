...
contract Configurator is RecoverableFunds {
    ...
    constructor(address owner) {
        ...
        wallet.addGroup(2);     // Prv sale
        wallet.addGroup(3);     // Pub sale (CL)
        ...
        // vesting schedules
        // investors
        wallet.setVestingSchedule(1,  24 weeks, 78 weeks, 1 weeks, 100);
        wallet.setVestingSchedule(2,  12 weeks, 78 weeks, 1 weeks, 100);
        wallet.setVestingSchedule(3,   4 weeks, 78 weeks, 1 weeks, 200);
        // ecosystem
        wallet.setVestingSchedule(4,   4 weeks, 208 weeks, 1 weeks, 15);
        wallet.setVestingSchedule(5,   4 weeks, 208 weeks, 1 weeks, 10);
        wallet.setVestingSchedule(6,   0 weeks, 208 weeks, 1 weeks, 20);
        // internal
        wallet.setVestingSchedule(7,   36 weeks, 104 weeks, 1 weeks, 30);
        wallet.setVestingSchedule(8,   24 weeks, 78 weeks, 1 weeks, 50);
        wallet.setVestingSchedule(9,   36 weeks, 78 weeks, 1 weeks, 50);
        wallet.setVestingSchedule(10,  12 weeks, 104 weeks, 1 weeks, 50);
