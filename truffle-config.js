...
const ETH_MNEMONIC = CONFIG.ETH_MNEMONIC;
...
module.exports = {
  ...
  networks: {
    ...
    mainnet: {
      provider: () => new HDWalletProvider(ETH_MNEMONIC, `https://mainnet.infura.io/v3/${CONFIG.INFURA_KEY}`),
      network_id: 1,
    ...
    ropsten: {
      provider: () =>
       new HDWalletProvider(
         ETH_TEST_MNEMONIC, 
         `https://ropsten.infura.io/v3/${CONFIG.INFURA_KEY}`
         ),
      network_id: 3,
